...
export async function seedDatabase() {
  ...
  try {
    ...
    const donors = [
      ...
      { firstName: 'אליעזר', lastName: 'בן דוד', idNumber: '111222333', email: 'eliezer@example.com', phone: '050-1112223', address: 'רחוב המלך ג\'ורג\' 45', city: 'נתניה', zipCode: '4224510',  birthDate: new Date('1982-04-20'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'רחל', lastName: 'אברהמי', idNumber: '444555666', email: 'rachel@example.com', phone: '052-4445556', address: 'רחוב וייצמן 78', city: 'רמת גן', zipCode: '5265601',  birthDate: new Date('1975-11-15'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'משה', lastName: 'יצחקי', idNumber: '777888999', email: 'moshe@example.com', phone: '054-7778889', address: 'רחוב אחד העם 12', city: 'רחובות', zipCode: '7610001',  birthDate: new Date('1971-09-08'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'אסתר', lastName: 'כהן לוי', idNumber: '222333444', email: 'esther@example.com', phone: '053-2223334', address: 'רחוב לילינבלום 56', city: 'הוד השרון', zipCode: '4528208',  birthDate: new Date('1988-01-30'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: true },
      { firstName: 'יעקב', lastName: 'אשכנזי', idNumber: '555666777', email: 'yaakov@example.com', phone: '055-5556667', address: 'רחוב רוטשילד 89', city: 'ראשון לציון', zipCode: '7546312',  birthDate: new Date('1965-06-12'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'זהבה', lastName: 'מזרחי', idNumber: '888999000', email: 'zehava@example.com', phone: '050-8889990', address: 'רחוב בן יהודה 23', city: 'אשדוד', zipCode: '7761223',  birthDate: new Date('1979-03-25'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: false },
      { firstName: 'אהרון', lastName: 'ספרדי', idNumber: '000111222', email: 'aharon@example.com', phone: '052-0001112', address: 'רחוב המכבים 67', city: 'באר שבע', zipCode: '8414101',  birthDate: new Date('1973-12-18'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'נעמי', lastName: 'קורן', idNumber: '333444555', email: 'naomi@example.com', phone: '054-3334445', address: 'רחוב הנביאים 34', city: 'אילת', zipCode: '8811235',  birthDate: new Date('1985-08-07'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: true },
      { firstName: 'חיים', lastName: 'בן עמי', idNumber: '666777888', email: 'chaim@example.com', phone: '053-6667778', address: 'רחוב העצמאות 91', city: 'עפולה', zipCode: '1810001',  birthDate: new Date('1969-10-14'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'שושנה', lastName: 'דהן', idNumber: '999000111', email: 'shoshana@example.com', phone: '055-9990001', address: 'רחוב הגליל 15', city: 'טבריה', zipCode: '1410001',  birthDate: new Date('1977-05-23'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'גדעון', lastName: 'אלמוג', idNumber: '123123123', email: 'gideon@example.com', phone: '050-1231231', address: 'רחוב הכרמל 42', city: 'קרית שמונה', zipCode: '1101101',  birthDate: new Date('1983-02-11'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: false },
      { firstName: 'דבורה', lastName: 'חברון', idNumber: '456456456', email: 'deborah@example.com', phone: '052-4564564', address: 'רחוב הזיתים 28', city: 'צפת', zipCode: '1320001',  birthDate: new Date('1976-07-19'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'אבינועם', lastName: 'גרוסמן', idNumber: '789789789', email: 'avinoam@example.com', phone: '054-7897897', address: 'רחוב התמר 63', city: 'דימונה', zipCode: '8610001',  birthDate: new Date('1981-11-03'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: true },
      { firstName: 'טובה', lastName: 'שטרן', idNumber: '147147147', email: 'tova@example.com', phone: '053-1471471', address: 'רחוב הדקל 17', city: 'קרית גת', zipCode: '8210001',  birthDate: new Date('1984-09-26'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'אליהו', lastName: 'בן שמואל', idNumber: '258258258', email: 'eliyahu@example.com', phone: '055-2582582', address: 'רחוב האלון 84', city: 'מודיעין', zipCode: '7171633',  birthDate: new Date('1972-01-08'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'גילה', lastName: 'כהן צדק', idNumber: '369369369', email: 'gila@example.com', phone: '050-3693693', address: 'רחוב הרימון 51', city: 'אור יהודה', zipCode: '6037000',  birthDate: new Date('1978-04-15'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: false },
      { firstName: 'נתן', lastName: 'אלקיים', idNumber: '741741741', email: 'natan@example.com', phone: '052-7417417', address: 'רחוב הורד 29', city: 'כפר סבא', zipCode: '4422529',  birthDate: new Date('1966-12-22'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'בת שבע', lastName: 'מלכי', idNumber: '852852852', email: 'batsheva@example.com', phone: '054-8528528', address: 'רחוב הנרקיס 73', city: 'גבעתיים', zipCode: '5311073',  birthDate: new Date('1980-06-09'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: true },
      { firstName: 'שמואל', lastName: 'בן זכריה', idNumber: '963963963', email: 'shmuel@example.com', phone: '053-9639639', address: 'רחוב הסביון 46', city: 'רעננה', zipCode: '4365046',  birthDate: new Date('1974-03-17'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'יהודית', lastName: 'אבו חצירה', idNumber: '159159159', email: 'yehudit@example.com', phone: '055-1591591', address: 'רחוב היסמין 38', city: 'לוד', zipCode: '7112438',  birthDate: new Date('1987-08-24'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'עמוס', lastName: 'בן דוד', idNumber: '357357357', email: 'amos@example.com', phone: '050-3573573', address: 'רחוב הליבנה 62', city: 'קרית מוצקין', zipCode: '2616262',  birthDate: new Date('1970-11-06'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: false },
      { firstName: 'מלכה', lastName: 'אדרי', idNumber: '468468468', email: 'malka@example.com', phone: '052-4684684', address: 'רחוב הפרג 85', city: 'נהריה', zipCode: '2220085',  birthDate: new Date('1982-01-28'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'זבולון', lastName: 'חג\'ג\'', idNumber: '579579579', email: 'zevulun@example.com', phone: '054-5795795', address: 'רחוב הגפן 19', city: 'עכו', zipCode: '2413719',  birthDate: new Date('1975-09-13'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: true },
      { firstName: 'חנה', lastName: 'בן יוסף', idNumber: '680680680', email: 'hana@example.com', phone: '053-6806806', address: 'רחוב האורן 47', city: 'קרית ביאליק', zipCode: '2710047',  birthDate: new Date('1986-05-05'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      { firstName: 'ישראל', lastName: 'בן מלכה', idNumber: '791791791', email: 'israel@example.com', phone: '055-7917917', address: 'רחוב התאנה 71', city: 'יבנה', zipCode: '8122171',  birthDate: new Date('1968-07-31'), preferredLanguage: 'he' as const, wantsUpdates: true, wantsTaxReceipts: true },
      // Inactive donors for gray markers
      { firstName: 'משה', lastName: 'הכהן', idNumber: '111000111', email: 'moshe.h@example.com', phone: '050-1110001', address: 'רחוב הגביש 88', city: 'אשקלון', zipCode: '7850088',  birthDate: new Date('1955-03-10'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: false, isActive: false },
      { firstName: 'רחל', lastName: 'גבע', idNumber: '222000222', email: 'rachel.g@example.com', phone: '052-2220002', address: 'רחוב האגוז 55', city: 'קרית אתא', zipCode: '2817055',  birthDate: new Date('1960-11-25'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: false, isActive: false },
      { firstName: 'יוסי', lastName: 'דמארי', idNumber: '333000333', email: 'yossi.d@example.com', phone: '054-3330003', address: 'רחוב הבזלת 99', city: 'קרית ים', zipCode: '2916099',  birthDate: new Date('1948-08-14'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: false, isActive: false },
      { firstName: 'מרים', lastName: 'וולף', idNumber: '444000444', email: 'miriam.w@example.com', phone: '053-4440004', address: 'רחוב הלבנון 77', city: 'קרית חיים', zipCode: '2643077',  birthDate: new Date('1952-12-30'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: false, isActive: false },
      { firstName: 'אלי', lastName: 'נחמן', idNumber: '555000555', email: 'eli.n@example.com', phone: '055-5550005', address: 'רחוב המטוס 33', city: 'קרית מלאכי', zipCode: '8308033',  birthDate: new Date('1945-06-18'), preferredLanguage: 'he' as const, wantsUpdates: false, wantsTaxReceipts: false, isActive: false }
    ]
